...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<form name="profileform" id="profileform" action="UpdateProfile"
						method="post">
							...
							<div class="control-group form-group">
								<div class="controls">
									...
									<label>First Name:</label> <input type="text" name="firstname"
										class="form-control" id="firstname" value="${p.firstname}"
										readonly required
							...
							<div class="control-group form-group">
								<div class="controls">
									<label>Last Name:</label> <input type="text"
										...
										value="${p.lastname}" readonly required
							...
							<div class="control-group form-group">
								<div class="controls">
									<label>Institution: </label> <input type="text"
										...
										value="${p.institution}" readonly required
							...
							<div class="control-group form-group">
								<div class="controls">
									<label>Department: </label> <input type="text"
										...
										value="${p.department}" readonly required
										data-validation-required-message="Please enter your institution.">
								</div>
							</div>
							<div class="control-group form-group">
								<div class="controls">
									<label>City: </label> <input type="text" class="form-control"
										name="city" id="city" value="${p.city}" readonly required
							...
							<div class="control-group form-group">
								<div class="controls">
									<label>State: </label> <input type="text" class="form-control"
										name="state" id="state" value="${p.state}" readonly required
							...
							<div class="control-group form-group">
								<div class="controls">
									<label>Country: </label> <input type="text"
										...
										value="${p.country}" readonly required
						...
						<button type="button" onclick="submitFunc(this.id)"
							id="submit_button" name="submit_button" class="btn btn-primary">Edit
							Info</button>
						</c:forEach>
					...
					<form action="YourGroups" id="YourGroups">
						<c:forEach var="d" items="${arr}">

							<input type="hidden" name="username1" id="username1"
								value="${d.username}" />
							<button type="button" onclick="yourGroupFunc(this.id)"
								id="yourGroup_button" name="yourGroup_button"
								class="btn btn-primary">Your Groups</button>
						</c:forEach>

					</form>

					<hr>
					<form action="UserGroup" id="UserGroup">
						<button type="button" onclick="groupFunc(this.id)"
							id="group_button" name="group_button" class="btn btn-primary">All
							Groups</button>
		...
		<script>
			function groupFunc(xyz) {

				document.getElementById("UserGroup").submit();
			}
		</script>
		<script>
			function yourGroupFunc(xyz) {

				document.getElementById("YourGroups").submit();
			}
		</script>
</body>
